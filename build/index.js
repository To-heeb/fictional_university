...
class Like {
  ...
  events() {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(".like-box").on("click", this.ourClickDispatcher.bind(this));
  } // methods


  ourClickDispatcher(e) {
    var currentLikeBox = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest(".like-box");
