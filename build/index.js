...
class Search {
  ...
  constructor() {
    ...
    this.searchOverlay = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay");
    this.searchField = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-term");
    this.resultsDiv = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__results");
    this.events();
  ...
  events() {
    ...
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keydown", this.keyPressDispatcher.bind(this));
  ...
  getResults() {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
                <div class='row'>
                    <div class='one-third'>
